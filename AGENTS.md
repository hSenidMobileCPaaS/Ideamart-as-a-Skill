...
in whatever the host project already uses. Reference implementations ship for TypeScript/Node,
Python, Java, Go, PHP and C#; [references/11-any-stack.md](references/11-any-stack.md)
specifies the same integration language-neutrally for anything else.

...
final class IdeamartCallbacks
{
     ...
     * identifiers carrying the final outcome. Read what you need, ignore
     * anything else, and log the raw body on your first Limited Production
     * charge so you can widen the handler if your account sends extra fields.
     *
     * @param array<string, mixed>|null $body
     */
